  ...
  <section id="offerings" className="import-section">
    ...
    <ColumnsTable>
      ...
      <tr>
        <td>class_nbr</td>
        <td>int</td>
        <td>Your university's unique identifier for this instance of this class. If this matches an existing offering, that will be updated.</td>
      </tr>
      <tr>
        <td>catalog_nbr</td>
        <td>int</td>
